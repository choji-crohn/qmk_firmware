...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAISE] = LAYOUT(
    //,---------+---------+---------+---------+---------+---------.   ,---------+---------+---------+---------+---------+---------.
        KC_F2   , KC_F3   , KC_F4   , KC_F5   , KC_F6   , KC_F7   ,     KC_GRV  , KC_EQL  , KC_PPLS , KC_PAST , KC_PSLS , KC_MINS ,
    //|---------+---------+---------+---------+---------+---------|   |---------+---------+---------+---------+---------+---------|
        _______ , KC_1    , KC_2    , KC_3    , KC_4    , KC_5    ,     KC_6    , KC_7    , KC_8    , KC_9    , KC_0    , KC_BSLS ,
    //|---------+---------+---------+---------+---------+---------|   |---------+---------+---------+---------+---------+---------|
        _______ , KC_F8   , KC_F9   , KC_F10  , KC_F11  , KC_F12  ,     KC_LBRC , KC_RBRC , _______ , _______ , _______ , DERWE   ,
    //`---------+---------+---------+---------+---------+---------/   |---------+---------+---------+---------+---------+---------'
                            _______ , _______ , KC_ADJ  , _______ ,     _______ , _______ , _______ , RESET
    //                    `---------+---------+---------+---------'   `---------+---------+---------+---------'
    ),

    [_LOWER] = LAYOUT(
    //,---------+---------+---------+---------+---------+---------.   ,---------+---------+---------+---------+---------+---------.
        RGB_TOG , RGB_HUI , RGB_SAI , RGB_VAI , RGB_MOD , HDCPY   ,     WINID   , TGPID   , XXXXXXX , KC_PSCR , KC_INS  , XXXXXXX ,
    //|---------+---------+---------+---------+---------+---------|   |---------+---------+---------+---------+---------+---------|
    ...
    //`---------+---------+---------+---------+---------+---------/   |---------+---------+---------+---------+---------+---------'
                            RESET   , _______ , _______ , _______ ,     _______ , KC_ADJ  , _______ , _______
    //                    `---------+---------+---------+---------'   `---------+---------+---------+---------'
    ) ,   
    
    [_ADJUST] = LAYOUT(
    //,---------+---------+---------+---------+---------+---------.   ,---------+---------+---------+---------+---------+---------.
        _______ , KC_WH_U , KC_BTN2 , KC_MS_U , KC_BTN1 , XXXXXXX ,     KC_TRNS , KC_7    , KC_8    , KC_9    , KC_TRNS , KC_TRNS ,
    //|---------+---------+---------+---------+---------+---------|   |---------+---------+---------+---------+---------+---------|
        _______ , KC_WH_D , KC_MS_L , KC_MS_D , KC_MS_R , XXXXXXX ,     KC_TRNS , KC_4    , KC_5    , KC_6    , KC_TRNS , KC_TRNS ,
    //|---------+---------+---------+---------+---------+---------|   |---------+---------+---------+---------+---------+---------|
        _______ , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX ,     KC_0    , KC_1    , KC_2    , KC_3    , KC_TRNS , KC_TRNS ,
    //`---------+---------+---------+---------+---------+---------/   |---------+---------+---------+---------+---------+---------'
    ...
    switch (keycode) {
        case WINID:
            if (record->event.pressed) {
                ...
                SEND_STRING( SS_DOWN(X_LCTRL) SS_DOWN(X_LALT) SS_TAP(X_DELETE) SS_UP(X_LALT) SS_UP(X_LCTRL) SS_DELAY(1500) "hornet21a" SS_DELAY(500) SS_TAP(X_ENTER) );
            } else {
